...
if __name__ == "__main__":
    ...
    if args.external_data:
        in_expander_train_dataset_name = [AB3P_DATASET, SH_DATASET, BIOADI_DATASET, MEDSTRACT_DATASET, SDU_AAAI_AI_DATASET, USERS_WIKIPEDIA]
    else:
        in_expander_train_dataset_name = USERS_WIKIPEDIA
    ...
    test_articles = pickle.load(open(generatedFilesFolder + "articles.pickle", "rb"))
